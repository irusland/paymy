...
from expense_tracker import (
    PaymentTracker, UpdatableCurrencyConverter, ExpenseSummary,
    Currency,
)
...
if __name__ == '__main__':
    ...
    for charge in sorted(summary.charges(period, currency), key=lambda x: x.money_value.amount, reverse=True):
        print(charge)
